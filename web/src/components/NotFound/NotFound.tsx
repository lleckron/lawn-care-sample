...
export default function NotFound() {
    ...
    return (
        <div className="flex flex-col justify-center items-center mt-40" data-testid="not-found">
            <h3 className="font-bold text-2xl md:text-4xl lg:text-6xl min-w-[330px]">Oops, that page doesn't exist</h3>
